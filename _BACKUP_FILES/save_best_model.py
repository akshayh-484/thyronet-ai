"""
Save the best trained model from neural_train_85plus.py
XGBoost: 78.90% accuracy
"""
...
print("="*80)
print("💾 SAVING BEST MODEL - XGBoost 78.90%")
print("="*80)
...
# Feature engineering (same as neural_train_85plus.py)
tsh = X['TSH_Level']
t3 = X['T3_Level']
t4 = X['T4_Level']
